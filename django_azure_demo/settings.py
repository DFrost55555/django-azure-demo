...
SECRET_KEY = ')d26$oxat5lst9(nujr^$y!oehx&v_h4he)8@r@vtxl+i0wpwf'
...
DEFAULT_FILE_STORAGE = 'django_azure_demo.custom_azure.AzureMediaStorage'
STATICFILES_STORAGE = 'django_azure_demo.custom_azure.AzureStaticStorage'
